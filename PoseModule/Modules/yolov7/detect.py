...
from Modules.yolov7.models.experimental import attempt_load
from Modules.yolov7.utils.datasets import LoadStreams, LoadImages
from Modules.yolov7.utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path, save_one_box
from Modules.yolov7.utils.plots import colors, plot_one_box
from Modules.yolov7.utils.torch_utils import select_device, load_classifier, time_synchronized


def detect(opt, scr):
    weights, view_img, save_txt, imgsz, save_txt_tidl, kpt_label = opt.weights, opt.view_img, opt.save_txt, opt.img_size, opt.save_txt_tidl, opt.kpt_label
    source = scr
